...
fclose($fichier);
    ...
    if ($fichier) {
        ...
        fclose($fichier);
        echo "Vous informations d'inscription : <p> Prénom: " . htmlspecialchars($prenom) . "</br> Nom: " . htmlspecialchars($nom) . "</br> Email: " . htmlspecialchars($email) . "</br> Mot de passe: " . htmlspecialchars($pass) . "</p>";
    } else {
